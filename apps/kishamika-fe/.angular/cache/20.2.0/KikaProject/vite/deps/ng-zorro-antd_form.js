import { NzGridModule } from './chunk-4623HUIB.js';
import { NzFormStatusService } from './chunk-OYNOX7CN.js';
import {
  CdkConnectedOverlay,
  CdkOverlayOrigin,
...
import { Directionality, isNotNil, toBoolean, warn } from './chunk-U7XIMOED.js';
import './chunk-D3I5WW37.js';
import { _defineProperty, _typeof, toPropertyKey } from './chunk-NHMQZRFA.js';
import { _getEventTarget } from './chunk-GHVILJXS.js';
import './chunk-7R5WSOKQ.js';
...
import { asapScheduler } from './chunk-HUZPAJME.js';
import {
  BehaviorSubject,
  Subject,
  Subscription,
...
import { __publicField, __spreadProps, __spreadValues } from './chunk-VC57AUI7.js';
...
function _unsupportedIterableToArray(r, a3) {
  if (r) {
    ...
    return (
      'Object' === t2 && r.constructor && (t2 = r.constructor.name),
      'Map' === t2 || 'Set' === t2
        ? Array.from(r)
        : 'Arguments' === t2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t2)
          ? _arrayLikeToArray(r, a3)
          : void 0
    );
  }
}
...
function _defineProperties(e2, r) {
  for (var t2 = 0; t2 < r.length; t2++) {
    ...
    ((o.enumerable = o.enumerable || false),
      ...
      Object.defineProperty(e2, toPropertyKey(o.key), o));
  }
}
function _createClass(e2, r, t2) {
  return (
    r && _defineProperties(e2.prototype, r),
    t2 && _defineProperties(e2, t2),
  ...
  getTimeResult(str) {
    ...
    if (match2) {
      if (isNotNil(this.matchMap.periodNarrow)) {
        ...
        ).indexOf(match2[this.matchMap.periodNarrow + 1]);
      }
      if (isNotNil(this.matchMap.periodWide)) {
        ...
        ).indexOf(match2[this.matchMap.periodWide + 1]);
      }
      if (isNotNil(this.matchMap.periodAbbreviated)) {
        ...
        ).indexOf(match2[this.matchMap.periodAbbreviated + 1]);
      }
      return {
        hour: isNotNil(this.matchMap.hour)
          ? Number.parseInt(match2[this.matchMap.hour + 1], 10)
          : null,
        minute: isNotNil(this.matchMap.minute)
          ? Number.parseInt(match2[this.matchMap.minute + 1], 10)
          : null,
        second: isNotNil(this.matchMap.second)
          ? Number.parseInt(match2[this.matchMap.second + 1], 10)
          : null,
        period,
      };
    } else {
...
var DateHelperService = class _DateHelperService {
  i18n;
  config = mergeDateConfig(
    inject(NZ_DATE_CONFIG, {
      optional: true,
    }),
  );
  constructor(i18n) {
...
var DateHelperByDatePipe = class extends DateHelperService {
  ...
  format(date, formatStr) {
    return date
      ? this.replaceQuarter(formatDate(date, formatStr, this.i18n.getLocaleId()), date)
      : '';
  }
  parseDate(text) {
  ...
  replaceQuarter(dateStr, date) {
    ...
    return dateStr
      .replace(/Q+(?![^[]*])/g, (match2) => record[match2] ?? quarter)
      .replace(/\[(Q+)]/g, '$1');
  }
};
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function NzNoAnimationDirective_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp(
          'nz-animate-disabled',
          ctx.nzNoAnimation || ctx.animationType === 'NoopAnimations',
        );
      }
    },
    inputs: {
...
var DEFAULT_DATE_PICKER_POSITIONS = [
...
function NzTooltipComponent_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(
      5,
      NzTooltipComponent_ng_template_0_ng_container_5_Template,
      2,
      1,
      'ng-container',
      7,
  ...
  if (rf & 2) {
    ...
    ɵɵproperty(
      '@.disabled',
      !!(ctx_r1.noAnimation == null ? null : ctx_r1.noAnimation.nzNoAnimation),
    )('nzNoAnimation', ctx_r1.noAnimation == null ? null : ctx_r1.noAnimation.nzNoAnimation)(
      '@zoomBigMotion',
      'active',
    );
    ɵɵadvance(3);
...
var NzTooltipBaseDirective = class _NzTooltipBaseDirective {
  ...
  registerTriggers() {
    ...
    if (trigger === 'hover') {
      ...
      this.triggerDisposables.push(
        this.renderer.listen(el, 'click', (e2) => {
          e2.preventDefault();
          this.show();
        }),
      );
...
var NzTooltipBaseComponent = class _NzTooltipBaseComponent {
  ...
  updateStyles() {
    this._classMap = __spreadProps(
      __spreadValues({}, this.transformClassListToMap(this.nzOverlayClassName)),
      {
...
var NzTooltipComponent = class _NzTooltipComponent extends NzTooltipBaseComponent {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function NzTooltipComponent_Factory(__ngFactoryType__) {
      return (
        ɵNzTooltipComponent_BaseFactory ||
        (ɵNzTooltipComponent_BaseFactory = ɵɵgetInheritedFactory(_NzTooltipComponent))
      )(__ngFactoryType__ || _NzTooltipComponent);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function NzTooltipComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(
          0,
          NzTooltipComponent_ng_template_0_Template,
          6,
          15,
          'ng-template',
          1,
        ...
        ɵɵlistener(
          'overlayOutsideClick',
          function NzTooltipComponent_Template_ng_template_overlayOutsideClick_0_listener($event) {
            ɵɵrestoreView(_r1);
          ...
          'positionChange',
          function NzTooltipComponent_Template_ng_template_positionChange_0_listener($event) {
            ɵɵrestoreView(_r1);
      ...
      if (rf & 2) {
        ɵɵproperty('cdkConnectedOverlayOrigin', ctx.origin)(
          'cdkConnectedOverlayOpen',
          ctx._visible,
        )('cdkConnectedOverlayPositions', ctx._positions)(
          'cdkConnectedOverlayPush',
          ctx.cdkConnectedOverlayPush,
        )('nzArrowPointAtCenter', ctx.nzArrowPointAtCenter);
      }
    },
    dependencies: [
      OverlayModule,
...
function NzFormControlComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(
      2,
      NzFormControlComponent_Conditional_3_ng_container_2_Template,
      2,
      1,
      'ng-container',
      5,
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty('nzStringTemplateOutlet', ctx_r0.innerTip)(
      'nzStringTemplateOutletContext',
      ɵɵpureFunction1(7, _c2, ctx_r0.validateControl),
    );
  }
}
...
function NzFormControlComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(
      1,
      NzFormControlComponent_Conditional_4_ng_container_1_Template,
      2,
      1,
      'ng-container',
      6,
...
function NzFormLabelComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(
      1,
      NzFormLabelComponent_Conditional_2_ng_container_1_Template,
      2,
      2,
      'ng-container',
      1,
...
var NzFormItemComponent = class _NzFormItemComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function NzFormItemComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('ant-form-item-has-success', ctx.status === 'success')(
          'ant-form-item-has-warning',
          ctx.status === 'warning',
        )('ant-form-item-has-error', ctx.status === 'error')(
          'ant-form-item-is-validating',
          ctx.status === 'validating',
        )('ant-form-item-has-feedback', ctx.hasFeedback && ctx.status)(
...
var NzFormDirective = (() => {
  ...
  return (
    (_a = class {
      ...
      nzAutoTips =
        (__runInitializers(this, _nzNoColon_extraInitializers),
        __runInitializers(this, _nzAutoTips_initializers, {}));
    ...
    (() => {
      ...
      __esDecorate(
        ...
        _nzNoColon_initializers,
        _nzNoColon_extraInitializers,
      );
      __esDecorate(
        null,
        null,
        _nzAutoTips_decorators,
        {
          kind: 'field',
          name: 'nzAutoTips',
          static: false,
        ...
        _nzAutoTips_initializers,
        _nzAutoTips_extraInitializers,
      );
      __esDecorate(
        null,
        null,
        _nzTooltipIcon_decorators,
        {
          kind: 'field',
          name: 'nzTooltipIcon',
          static: false,
        ...
        _nzTooltipIcon_initializers,
        _nzTooltipIcon_extraInitializers,
      );
      __esDecorate(
        null,
        null,
        _nzLabelWrap_decorators,
        {
          kind: 'field',
          name: 'nzLabelWrap',
          static: false,
        ...
        _nzLabelWrap_initializers,
        _nzLabelWrap_extraInitializers,
      );
      if (_metadata)
    ...
    __publicField(
      ...
      ɵɵdefineDirective({
        ...
        hostBindings: function NzFormDirective_HostBindings(rf, ctx) {
          if (rf & 2) {
            ɵɵclassProp('ant-form-horizontal', ctx.nzLayout === 'horizontal')(
              'ant-form-vertical',
              ctx.nzLayout === 'vertical',
            )('ant-form-inline', ctx.nzLayout === 'inline')('ant-form-rtl', ctx.dir === 'rtl');
          }
        },
        inputs: {
          nzLayout: 'nzLayout',
...
var NzFormControlComponent = class _NzFormControlComponent {
  ...
  constructor() {
    this.subscribeAutoTips(
      this.i18n.localeChange.pipe(tap((locale2) => (this.localeId = locale2.locale))),
    );
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable('nzAutoTips'));
    this.subscribeAutoTips(
      this.nzFormDirective
        ?.getInputObservable('nzDisableAutoTips')
        .pipe(filter(() => this.nzDisableAutoTips === void 0)),
    );
  }
  ngOnChanges(changes) {
    const {
...
var NzFormLabelComponent = class _NzFormLabelComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function NzFormLabelComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('ant-form-item-label-left', ctx.nzLabelAlign === 'left')(
    ...
    template: function NzFormLabelComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵclassProp('ant-form-item-no-colon', ctx.nzNoColon)(

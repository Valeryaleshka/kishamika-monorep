...
import { Directionality, fromEventOutsideAngular } from './chunk-U7XIMOED.js';
import './chunk-D3I5WW37.js';
import './chunk-NHMQZRFA.js';
import { NzTransitionPatchModule } from './chunk-QRR2VSXT.js';
import { NzWaveModule } from './chunk-6MHS5CVY.js';
...
import { DestroyRef, computed, inject, signal, ɵɵdefineInjector } from './chunk-USC2B2WM.js';
import './chunk-NFRTRQTS.js';
import './chunk-HUZPAJME.js';
import { Subject, __esDecorate, __runInitializers, filter, startWith } from './chunk-PVVX4OOT.js';
      ...
      ɵɵdefineComponent({
        ...
        hostBindings: function NzButtonComponent_HostBindings(rf, ctx) {
          if (rf & 2) {
            ɵɵattribute(
              'tabindex',
              ctx.disabled ? -1 : ctx.tabIndex === null ? null : ctx.tabIndex,
            )('disabled', ctx.disabled || null);
            ɵɵclassProp('ant-btn-default', ctx.nzType === 'default')(
              'ant-btn-primary',
              ctx.nzType === 'primary',
            )('ant-btn-dashed', ctx.nzType === 'dashed')('ant-btn-link', ctx.nzType === 'link')(
              'ant-btn-text',
              ctx.nzType === 'text',
            )('ant-btn-circle', ctx.nzShape === 'circle')('ant-btn-round', ctx.nzShape === 'round')(
              'ant-btn-lg',
              ctx.finalSize() === 'large',
            )('ant-btn-sm', ctx.finalSize() === 'small')('ant-btn-dangerous', ctx.nzDanger)(
              'ant-btn-loading',
              ctx.nzLoading,
            )('ant-btn-background-ghost', ctx.nzGhost)('ant-btn-block', ctx.nzBlock)(
              'ant-input-search-button',
              ctx.nzSearch,
            )('ant-btn-rtl', ctx.dir === 'rtl')('ant-btn-icon-only', ctx.iconOnly);
          }
        },
        inputs: {

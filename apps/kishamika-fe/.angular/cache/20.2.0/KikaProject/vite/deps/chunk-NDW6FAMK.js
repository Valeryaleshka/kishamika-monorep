...
import { Subject, Subscription, map } from './chunk-PVVX4OOT.js';
import { __async, __spreadProps, __spreadValues } from './chunk-VC57AUI7.js';
...
function setupInitialInputs(tNode, directiveIndex, isHostDirective) {
  ...
  if (
    ...
    (isHostDirective && hostDirectiveInputs === null) || // Do not use unbound attributes as inputs to structural directives, since structural
...
var areAnimationSupported =
  typeof document !== 'undefined' && // tslint:disable-next-line:no-toplevel-property-access
...
function internalProvideZoneChangeDetection({
  ...
  ngZoneFactory ??= () =>
    new NgZone(__spreadProps(__spreadValues({}, getNgZoneOptions()), { scheduleInRootZone }));
  return [
  ...
  return ngZone.run(() => {
    ...
    if (typeof ngDevMode === 'undefined' || ngDevMode) {
      if (envInjector.get(PROVIDED_ZONELESS) && envInjector.get(PROVIDED_NG_ZONE)) {
        throw new RuntimeError(
          408,
          'Invalid change detection configuration: provideZoneChangeDetection and provideZonelessChangeDetection cannot be used together.',
        );
      }
    }
...
@angular/core/fesm2022/debug_node.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-NDW6FAMK.js.map

import { NzIconDirective, NzIconModule } from './chunk-W2Y6ESBF.js';
import {
...
import { inject, ɵɵdefineInjectable } from './chunk-USC2B2WM.js';
import { BehaviorSubject, ReplaySubject } from './chunk-PVVX4OOT.js';
...
var NzFormItemFeedbackIconComponent = class _NzFormItemFeedbackIconComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function NzFormItemFeedbackIconComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('ant-form-item-feedback-icon-error', ctx.status === 'error')(
          'ant-form-item-feedback-icon-warning',
          ctx.status === 'warning',
        )('ant-form-item-feedback-icon-success', ctx.status === 'success')(
    ...
    template: function NzFormItemFeedbackIconComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵconditionalCreate(
          0,
          NzFormItemFeedbackIconComponent_Conditional_0_Template,
          1,
          1,
          'nz-icon',
          0,
...
export { NzFormStatusService, NzFormNoStatusService, NzFormItemFeedbackIconComponent };
//# sourceMappingURL=chunk-OYNOX7CN.js.map

import { __yieldStar } from './chunk-VC57AUI7.js';
...
function groupSort(values, reduce2, key) {
  return (
    reduce2.length !== 2
      ...
      : sort(group(values, key), ([ak, av], [bk, bv]) => reduce2(av, bv) || ascending(ak, bk))
  ).map(([key2]) => key2);
}
...
function ticks(start2, stop, count3) {
  ...
  const reverse2 = stop < start2,
    [i1, i2, inc2] = reverse2 ? tickSpec(stop, start2, count3) : tickSpec(start2, stop, count3);
  if (!(i2 >= i1)) return [];
  const n = i2 - i1 + 1,
    ticks2 = new Array(n);
  if (reverse2) {
...
function tickStep(start2, stop, count3) {
  ((stop = +stop), (start2 = +start2), (count3 = +count3));
  const reverse2 = stop < start2,
    inc2 = reverse2 ? tickIncrement(stop, start2, count3) : tickIncrement(start2, stop, count3);
...
function bin() {
  ...
  histogram.thresholds = function (_) {
    return arguments.length
      ? ((threshold2 =
          typeof _ === 'function' ? _ : constant(Array.isArray(_) ? slice.call(_) : _)),
        histogram)
      : threshold2;
  };
  return histogram;
...
function range(start2, stop, step) {
  ((start2 = +start2),
    (stop = +stop),
    (step = (n = arguments.length) < 2 ? ((stop = start2), (start2 = 0), 1) : n < 3 ? 1 : +step));
  var i = -1,
...
function rank(values, valueof = ascending) {
  ...
  values.sort(
    valueof === ascending ? (i, j) => ascendingDefined(V[i], V[j]) : compareDefined(compareIndex),
  );
  values.forEach((j, i) => {
...
function axis(orient, scale2) {
  ...
  function axis2(context) {
    ...
    path2 = path2.merge(
      path2.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', 'currentColor'),
    );
...
function select_default(select) {
  ...
  for (
    var groups2 = this._groups, m3 = groups2.length, subgroups = new Array(m3), j = 0;
    j < m3;
    ++j
  ) {
    for (
...
function selectAll_default(select) {
  ...
  for (
    var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0;
    j < m3;
    ++j
  ) {
...
function filter_default(match) {
  ...
  for (
    ...
    for (
      var group2 = groups2[j], n = group2.length, subgroup = (subgroups[j] = []), node, i = 0;
      i < n;
      ++i
    ) {
...
function sort_default(compare) {
  ...
  for (
    var groups2 = this._groups, m3 = groups2.length, sortgroups = new Array(m3), j = 0;
    j < m3;
    ++j
  ) {
    for (
...
function dispatch_default2(type2, params) {
  return this.each(
    (typeof params === 'function' ? dispatchFunction : dispatchConstant)(type2, params),
  );
}
...
function DragEvent(
  type2,
  { sourceEvent, subject, target, identifier, active, x: x4, y: y4, dx, dy, dispatch: dispatch2 },
) {
  Object.defineProperties(this, {
...
function drag_default() {
  ...
  drag.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === 'function' ? _ : constant_default2(!!_)), drag)
      : touchable;
  };
  drag.on = function () {
  ...
  return (m3 = reHex.exec(format2))
    ? ((l = m3[1].length),
      ...
      l === 6
        ...
        : l === 3
          ...
          : l === 8
            ? rgba((m3 >> 24) & 255, (m3 >> 16) & 255, (m3 >> 8) & 255, (m3 & 255) / 255)
            : l === 4
              ? rgba(
                  ((m3 >> 12) & 15) | ((m3 >> 8) & 240),
                  ((m3 >> 8) & 15) | ((m3 >> 4) & 240),
    ...
    : (m3 = reRgbInteger.exec(format2))
      ...
      : (m3 = reRgbPercent.exec(format2))
        ? new Rgb((m3[1] * 255) / 100, (m3[2] * 255) / 100, (m3[3] * 255) / 100, 1)
        : (m3 = reRgbaInteger.exec(format2))
          ? rgba(m3[1], m3[2], m3[3], m3[4])
          : (m3 = reRgbaPercent.exec(format2))
            ? rgba((m3[1] * 255) / 100, (m3[2] * 255) / 100, (m3[3] * 255) / 100, m3[4])
...
var backInOut = (function custom6(s2) {
  ...
  function backInOut2(t) {
    return (
      ((t *= 2) < 1 ? t * t * ((s2 + 1) * t - s2) : (t -= 2) * t * ((s2 + 1) * t + s2) + 2) / 2
    );
  }
...
function BrushEvent(
  type2,
  { sourceEvent, target, selection: selection2, mode: mode2, dispatch: dispatch2 },
) {
  Object.defineProperties(this, {
    type: { value: type2, enumerable: true, configurable: true },
    sourceEvent: { value: sourceEvent, enumerable: true, configurable: true },
...
function brush(dim) {
  ...
  brush2.extent = function (_) {
    return arguments.length
      ? ((extent2 = typeof _ === 'function' ? _ : constant_default4(number22(_))), brush2)
      : extent2;
  };
  brush2.filter = function (_) {
    return arguments.length
      ? ((filter3 = typeof _ === 'function' ? _ : constant_default4(!!_)), brush2)
      : filter3;
  };
  brush2.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === 'function' ? _ : constant_default4(!!_)), brush2)
      : touchable;
  };
...
function chord(directed, transpose2) {
  ...
  chord2.sortChords = function (_) {
    return arguments.length
      ? (_ == null ? (sortChords = null) : ((sortChords = compareValue(_))._ = _), chord2)
...
function ribbon(headRadius) {
  ...
  if (headRadius)
    ribbon2.headRadius = function (_) {
      return arguments.length
        ? ((headRadius = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
        : headRadius;
    };
  ribbon2.radius = function (_) {
    return arguments.length
      ? ((sourceRadius = targetRadius = typeof _ === 'function' ? _ : constant_default5(+_)),
        ribbon2)
      : sourceRadius;
  };
  ribbon2.sourceRadius = function (_) {
    return arguments.length
      ? ((sourceRadius = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
      : sourceRadius;
  };
  ribbon2.targetRadius = function (_) {
    return arguments.length
      ? ((targetRadius = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
      : targetRadius;
  };
  ribbon2.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
      : startAngle;
  };
  ribbon2.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
      : endAngle;
  };
  ribbon2.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === 'function' ? _ : constant_default5(+_)), ribbon2)
      : padAngle;
  };
...
function density_default() {
  ...
  density.weight = function (_) {
    return arguments.length
      ? ((weight = typeof _ === 'function' ? _ : constant_default6(+_)), density)
      : weight;
  };
...
var Delaunator = class _Delaunator {
  ...
  update() {
    ...
    for (let k2 = 0, xp, yp; k2 < this._ids.length; k2++) {
      ...
      while (
        ((q = hullNext[e]),
        orient2d(x4, y4, coords[2 * e], coords[2 * e + 1], coords[2 * q], coords[2 * q + 1]) >= 0)
      ) {
        e = q;
        if (e === start2) {
          e = -1;
      ...
      while (
        ((q = hullNext[n2]),
        orient2d(x4, y4, coords[2 * n2], coords[2 * n2 + 1], coords[2 * q], coords[2 * q + 1]) < 0)
      ) {
      ...
      if (e === start2) {
        while (
          ((q = hullPrev[e]),
          orient2d(x4, y4, coords[2 * q], coords[2 * q + 1], coords[2 * e], coords[2 * e + 1]) < 0)
        ) {
...
var Voronoi = class {
  ...
  *neighbors(i) {
  ...
  _regioncode(x4, y4) {
    return (
      (x4 < this.xmin ? 1 : x4 > this.xmax ? 2 : 0) | (y4 < this.ymin ? 4 : y4 > this.ymax ? 8 : 0)
    );
  }
  _simplify(P) {
    if (P && P.length > 4) {
    ...
    : formatYear(date2.getUTCFullYear(), 4) +
        ...
        (milliseconds2
          ? 'T' +
            ...
            'Z'
          : seconds2
            ? 'T' + pad(hours, 2) + ':' + pad(minutes, 2) + ':' + pad(seconds2, 2) + 'Z'
            : minutes || hours
...
function parser(type2) {
  return (input, init2) =>
    text_default3(input, init2).then((text) => new DOMParser().parseFromString(text, type2));
}
...
function visit_default(callback) {
  ...
  while ((q = quads.pop())) {
    if (
      !callback((node = q.node), (x06 = q.x0), (y06 = q.y0), (x12 = q.x1), (y12 = q.y1)) &&
      node.length
    ) {
      var xm = (x06 + x12) / 2,
        ym = (y06 + y12) / 2;
...
function collide_default(radius) {
  ...
  force.radius = function (_) {
    return arguments.length
      ? ((radius = typeof _ === 'function' ? _ : constant_default7(+_)), initialize(), force)
      : radius;
  };
  return force;
}
...
function link_default(links) {
  ...
  function initialize() {
    ...
    for (i = 0, bias = new Array(m3); i < m3; ++i) {
      ((link3 = links[i]),
        (bias[i] =
          count3[link3.source.index] / (count3[link3.source.index] + count3[link3.target.index])));
    }
...
function manyBody_default() {
  ...
  force.strength = function (_) {
    return arguments.length
      ? ((strength = typeof _ === 'function' ? _ : constant_default7(+_)), initialize(), force)
      : strength;
  };
...
function x_default2(x4) {
  ...
  force.x = function (_) {
    return arguments.length
      ? ((x4 = typeof _ === 'function' ? _ : constant_default7(+_)), initialize(), force)
      : x4;
  };
  return force;
}
...
function y_default2(y4) {
  ...
  force.y = function (_) {
    return arguments.length
      ? ((y4 = typeof _ === 'function' ? _ : constant_default7(+_)), initialize(), force)
      : y4;
  };
  return force;
}
  ...
  return i === n
    ...
    : i > n
      ...
      : i > 0
        ...
        : '0.' + new Array(1 - i).join('0') + formatDecimalParts(x4, Math.max(0, p + i - 1))[0];
}
        ...
        if (maybeSuffix) {
          ...
          while (++i < n) {
            if (((c6 = value.charCodeAt(i)), 48 > c6 || c6 > 57)) {
              valueSuffix =
                (c6 === 46 ? decimal + value.slice(i + 1) : value.slice(i)) + valueSuffix;
...
function centroidLinePoint(lambda, phi2) {
  ...
  var cosPhi = cos2(phi2),
    ...
    z = sin2(phi2),
    w = atan2(
      sqrt((w = y0 * z - z0 * y4) * w + (w = z0 * x4 - x0 * z) * w + (w = x0 * y4 - y0 * x4) * w),
      x0 * x4 + y0 * y4 + z0 * z,
    );
  W1 += w;
  X1 += w * (x0 + (x0 = x4));
...
function circle_default() {
  ...
  circle.center = function (_) {
    return arguments.length
      ? ((center2 = typeof _ === 'function' ? _ : constant_default8([+_[0], +_[1]])), circle)
      : center2;
  };
  ...
  circle.precision = function (_) {
    return arguments.length
      ? ((precision = typeof _ === 'function' ? _ : constant_default8(+_)), circle)
      : precision;
  };
  return circle;
}
...
function polygonContains_default(polygon, point6) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (
      var j = 0;
      j < m3;
      ++j, lambda04 = lambda12, sinPhi03 = sinPhi1, cosPhi03 = cosPhi1, point0 = point1
    ) {
      var point1 = ring[j],
...
function circle_default2(radius) {
  ...
  function intersect2(a4, b, two) {
    ...
    if (
      meridian
        ? polar
          ? (phi02 + phi12 > 0) ^ (q[1] < (abs3(q[0] - lambda04) < epsilon7 ? phi02 : phi12))
          : phi02 <= q[1] && q[1] <= phi12
...
function path_default(projection2, context) {
  ...
  path2.projection = function (_) {
    ...
    projectionStream =
      _ == null ? ((projection2 = null), identity_default3) : (projection2 = _).stream;
    return path2;
  };
  path2.context = function (_) {
    if (!arguments.length) return context;
    contextStream =
      _ == null ? ((context = null), new PathString(digits)) : new PathContext((context = _));
...
function projectionMutator(projectAt) {
  ...
  projection2.center = function (_) {
    return arguments.length
      ? ((lambda = (_[0] % 360) * radians2), (phi2 = (_[1] % 360) * radians2), recenter())
  ...
  projection2.precision = function (_) {
    return arguments.length
      ? ((projectResample = resample_default(projectTransform, (delta2 = _ * _))), reset())
      : sqrt(delta2);
  };
  ...
  function recenter() {
    var center2 = scaleTranslateRotate(k2, 0, 0, sx, sy, alpha).apply(null, project(lambda, phi2)),
  ...
  m3.clipExtent = function (_) {
    return arguments.length
      ? (_ == null
          ...
          : ((x06 = +_[0][0]), (y06 = +_[0][1]), (x12 = +_[1][0]), (y12 = +_[1][1])),
        reclip())
      : x06 == null
        ? null
        : [
...
function identity_default4() {
  ...
  projection2.angle = function (_) {
    return arguments.length
      ? ((alpha = (_ % 360) * radians2), (sa = sin2(alpha)), (ca3 = cos2(alpha)), reset())
      : alpha * degrees3;
  };
  projection2.reflectX = function (_) {
...
function naturalEarth1Raw(lambda, phi2) {
  ...
  return [
    lambda *
      (0.8707 - 0.131979 * phi22 + phi4 * (-0.013791 + phi4 * (3971e-6 * phi22 - 1529e-6 * phi4))),
...
naturalEarth1Raw.invert = function (x4, y4) {
  ...
  do {
    ...
    phi2 -= delta =
      (phi2 *
        (1.007226 + phi22 * (0.015085 + phi4 * (-0.044475 + 0.028874 * phi22 - 5916e-6 * phi4))) -
        y4) /
      (1.007226 +
        phi22 *
          (0.015085 * 3 + phi4 * (-0.044475 * 7 + 0.028874 * 9 * phi22 - 5916e-6 * 11 * phi4)));
...
function pack_default() {
  ...
  function pack(root3) {
    ...
    if (radius) {
      ...
      root3
        ...
        .eachAfter(packChildrenRandom(padding, root3.r / Math.min(dx, dy), random))
  ...
  pack.padding = function (x4) {
    return arguments.length
      ? ((padding = typeof x4 === 'function' ? x4 : constant_default9(+x4)), pack)
      : padding;
  };
  return pack;
}
...
function treemap_default() {
  ...
  treemap.paddingInner = function (x4) {
    return arguments.length
      ? ((paddingInner = typeof x4 === 'function' ? x4 : constant_default9(+x4)), treemap)
      : paddingInner;
  };
  treemap.paddingOuter = function (x4) {
    return arguments.length
      ? treemap.paddingTop(x4).paddingRight(x4).paddingBottom(x4).paddingLeft(x4)
      : treemap.paddingTop();
  };
  treemap.paddingTop = function (x4) {
    return arguments.length
      ? ((paddingTop = typeof x4 === 'function' ? x4 : constant_default9(+x4)), treemap)
      : paddingTop;
  };
  treemap.paddingRight = function (x4) {
    return arguments.length
      ? ((paddingRight = typeof x4 === 'function' ? x4 : constant_default9(+x4)), treemap)
      : paddingRight;
  };
  treemap.paddingBottom = function (x4) {
    return arguments.length
      ? ((paddingBottom = typeof x4 === 'function' ? x4 : constant_default9(+x4)), treemap)
      : paddingBottom;
  };
  treemap.paddingLeft = function (x4) {
    return arguments.length
      ? ((paddingLeft = typeof x4 === 'function' ? x4 : constant_default9(+x4)), treemap)
      : paddingLeft;
  };
  return treemap;
}
...
function computeUpperHullIndexes(points) {
  ...
  for (i = 2; i < n; ++i) {
    while (
      size > 1 &&
      cross_default(points[indexes2[size - 2]], points[indexes2[size - 1]], points[i]) <= 0
    )
      --size;
    indexes2[size++] = i;
  }
...
function transformer2() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN((x4 = +x4))
      ? unknown
      : (output || (output = piecewise2(domain.map(transform2), range4, interpolate)))(
          transform2(clamp(x4)),
        );
  }
  scale2.invert = function (y4) {
    return clamp(
      untransform(
        (input || (input = piecewise2(range4, domain.map(transform2), number_default)))(y4),
      ),
    );
  };
  scale2.domain = function (_) {
  ...
  switch (specifier.type) {
    ...
    case 'r': {
      if (
        ...
        !isNaN(
          (precision = precisionRound_default(step, Math.max(Math.abs(start2), Math.abs(stop)))),
        )
      )
...
function threshold() {
  ...
  scale2.domain = function (_) {
    return arguments.length
      ? ((domain = Array.from(_)), (n = Math.min(domain.length, range4.length - 1)), scale2)
      : domain.slice();
  };
  scale2.range = function (_) {
    return arguments.length
      ? ((range4 = Array.from(_)), (n = Math.min(domain.length, range4.length - 1)), scale2)
      : range4.slice();
  };
  scale2.invertExtent = function (y4) {
    var i = range4.indexOf(y4);
    ...
    interval2.every = (step) => {
      ...
      return !isFinite(step) || !(step > 0)
        ...
        : !(step > 1)
          ? interval2
          : interval2.filter(
              field ? (d) => field(d) % step === 0 : (d) => interval2.count(0, d) % step === 0,
            );
    };
  }
  return interval2;
...
var timeDay = timeInterval(
  ...
  (start2, end) =>
    (end - start2 - (end.getTimezoneOffset() - start2.getTimezoneOffset()) * durationMinute) /
    durationDay,
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start2, stop, count3) {
    ...
    const interval2 =
      count3 && typeof count3.range === 'function' ? count3 : tickInterval(start2, stop, count3);
  ...
  function scale2(x4) {
    return x4 == null || isNaN((x4 = +x4))
      ...
      : interpolator(
          k10 === 0
            ? 0.5
            : ((x4 = (transform2(x4) - t03) * k10), clamp ? Math.max(0, Math.min(1, x4)) : x4),
        );
  }
  scale2.domain = function (_) {
    return arguments.length
...
function transformer4() {
  ...
  function scale2(x4) {
    return isNaN((x4 = +x4))
      ? unknown
      : ((x4 = 0.5 + ((x4 = +transform2(x4)) - t13) * (s2 * x4 < s2 * t13 ? k10 : k21)),
  ...
  function range4(interpolate) {
    return function (_) {
      var r0, r1, r2;
      return arguments.length
        ? (([r0, r1, r2] = _), (interpolator = piecewise(interpolate, [r0, r1, r2])), scale2)
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon8)) context.moveTo(0, 0);
      ...
      var a01 = a0,
        ...
        rp =
          ap > epsilon8 &&
          (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)),
          ...
          if ((oc = intersect(x01, y01, x004, y004, x11, y11, x10, y10))) {
            var ax = x01 - oc[0],
              ...
              kc =
                ...
                sin3(
                  acos2(
                    (ax * bx + ay * by) / (sqrt3(ax * ax + ay * ay) * sqrt3(bx * bx + by * by)),
                  ) / 2,
                ),
  ...
  arc.innerRadius = function (_) {
    return arguments.length
      ? ((innerRadius = typeof _ === 'function' ? _ : constant_default10(+_)), arc)
      : innerRadius;
  };
  arc.outerRadius = function (_) {
    return arguments.length
      ? ((outerRadius = typeof _ === 'function' ? _ : constant_default10(+_)), arc)
      : outerRadius;
  };
  arc.cornerRadius = function (_) {
    return arguments.length
      ? ((cornerRadius = typeof _ === 'function' ? _ : constant_default10(+_)), arc)
      : cornerRadius;
  };
  arc.padRadius = function (_) {
    return arguments.length
      ? ((padRadius = _ == null ? null : typeof _ === 'function' ? _ : constant_default10(+_)), arc)
      : padRadius;
  };
  arc.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === 'function' ? _ : constant_default10(+_)), arc)
      : startAngle;
  };
...
function line_default2(x4, y4) {
  ...
  line.defined = function (_) {
    return arguments.length
      ? ((defined = typeof _ === 'function' ? _ : constant_default10(!!_)), line)
      : defined;
  };
...
function area_default5(x06, y06, y12) {
  ...
  area.x = function (_) {
    return arguments.length
      ? ((x06 = typeof _ === 'function' ? _ : constant_default10(+_)), (x12 = null), area)
      : x06;
  };
  area.x0 = function (_) {
    return arguments.length
  ...
  area.x1 = function (_) {
    return arguments.length
      ? ((x12 = _ == null ? null : typeof _ === 'function' ? _ : constant_default10(+_)), area)
      : x12;
  };
  area.y = function (_) {
    return arguments.length
      ? ((y06 = typeof _ === 'function' ? _ : constant_default10(+_)), (y12 = null), area)
      : y06;
  };
  area.y0 = function (_) {
    return arguments.length
  ...
  area.y1 = function (_) {
    return arguments.length
      ? ((y12 = _ == null ? null : typeof _ === 'function' ? _ : constant_default10(+_)), area)
      : y12;
  };
  ...
  area.defined = function (_) {
    return arguments.length
      ? ((defined = typeof _ === 'function' ? _ : constant_default10(!!_)), area)
      : defined;
  };
...
function pie_default() {
  ...
  pie.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === 'function' ? _ : constant_default10(+_)), pie)
      : startAngle;
  };
...
function stack_default() {
  ...
  stack.keys = function (_) {
    return arguments.length
      ? ((keys = typeof _ === 'function' ? _ : constant_default10(Array.from(_))), stack)
      : keys;
  };
...
function zoom_default2() {
    ...
    if (collection !== selection2) {
      ...
      selection2.interrupt().each(function () {
        gesture(this, arguments)
          ...
          .zoom(
            null,
            typeof transform2 === 'function' ? transform2.apply(this, arguments) : transform2,
          )
          .end();
      });
    }
    ...
    zoom.transform(
      ...
      function () {
        var e = extent2.apply(this, arguments),
          t03 = this.__zoom,
          p02 = p == null ? centroid(e) : typeof p === 'function' ? p.apply(this, arguments) : p,
          p1 = t03.invert(p02),
          k1 = typeof k2 === 'function' ? k2.apply(this, arguments) : k2;
  ...
  function wheeled(event, ...args) {
    ...
    g.zoom(
      'mouse',
      constrain(translate(scale2(t, k2), g.mouse[0], g.mouse[1]), g.extent, translateExtent),
    );
    function wheelidled() {
      g.wheel = null;
      g.end();
  ...
  zoom.wheelDelta = function (_) {
    return arguments.length
      ? ((wheelDelta = typeof _ === 'function' ? _ : constant_default11(+_)), zoom)
      : wheelDelta;
  };
  zoom.filter = function (_) {
    return arguments.length
      ? ((filter3 = typeof _ === 'function' ? _ : constant_default11(!!_)), zoom)
      : filter3;
  };
  zoom.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === 'function' ? _ : constant_default11(!!_)), zoom)
      : touchable;
  };

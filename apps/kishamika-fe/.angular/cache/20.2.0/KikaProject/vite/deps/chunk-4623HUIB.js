import { MediaMatcher, NzBreakpointService, gridResponsiveMap } from './chunk-JQFDHKHC.js';
import { Directionality, isNotNil } from './chunk-U7XIMOED.js';
...
import { DestroyRef, inject, ɵɵdefineInjector } from './chunk-USC2B2WM.js';
import { ReplaySubject, Subject } from './chunk-PVVX4OOT.js';
...
var NzRowDirective = class _NzRowDirective {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function NzRowDirective_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('ant-row-top', ctx.nzAlign === 'top')(
          'ant-row-middle',
          ctx.nzAlign === 'middle',
        )('ant-row-bottom', ctx.nzAlign === 'bottom')('ant-row-start', ctx.nzJustify === 'start')(
          'ant-row-end',
          ctx.nzJustify === 'end',
        )('ant-row-center', ctx.nzJustify === 'center')(
          'ant-row-space-around',
          ctx.nzJustify === 'space-around',
        )('ant-row-space-between', ctx.nzJustify === 'space-between')(
          'ant-row-space-evenly',
          ctx.nzJustify === 'space-evenly',
        )('ant-row-rtl', ctx.dir === 'rtl');
      }
    },
    inputs: {
      nzAlign: 'nzAlign',
...
//# sourceMappingURL=chunk-4623HUIB.js.map

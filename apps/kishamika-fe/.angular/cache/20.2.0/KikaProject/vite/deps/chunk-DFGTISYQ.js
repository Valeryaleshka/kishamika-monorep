import { NzConfigService, NzStringTemplateOutletDirective, WithConfig } from './chunk-W2Y6ESBF.js';
import { Directionality } from './chunk-U7XIMOED.js';
import { takeUntilDestroyed, toSignal } from './chunk-FBBY4FQW.js';
...
import { __esDecorate, __runInitializers } from './chunk-PVVX4OOT.js';
import { __publicField } from './chunk-VC57AUI7.js';
...
function NzSpaceComponent_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(
      1,
      NzSpaceComponent_For_2_Conditional_2_ng_template_1_Template,
      1,
      1,
      'ng-template',
      3,
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty('nzStringTemplateOutlet', ctx_r0.nzSplit)(
      'nzStringTemplateOutletContext',
      ɵɵpureFunction1(2, _c1, ɵ$index_2_r2),
    );
  }
}
...
var NzSpaceCompactComponent = class _NzSpaceCompactComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function NzSpaceCompactComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('ant-space-compact-block', ctx.nzBlock())(
          'ant-space-compact-vertical',
          ctx.nzDirection() === 'vertical',
        );
      }
    },
    inputs: {
  ...
  return (
    (_a = class {
      ...
      ngOnChanges(changes) {
        ...
        this.mergedAlign =
          this.nzAlign === void 0 && this.nzDirection === 'horizontal' ? 'center' : this.nzAlign;
      }
      ngAfterContentInit() {
    ...
    (() => {
      ...
      __esDecorate(
        ...
        _nzSize_initializers,
        _nzSize_extraInitializers,
      );
      if (_metadata)
    ...
    __publicField(
      ...
      ɵɵdefineComponent({
        ...
        hostBindings: function NzSpaceComponent_HostBindings(rf, ctx) {
          if (rf & 2) {
            ɵɵstyleProp('flex-wrap', ctx.nzWrap ? 'wrap' : null)(
              ...
              ctx.horizontalSize,
              'px',
            )('row-gap', ctx.verticalSize, 'px');
            ɵɵclassProp('ant-space-horizontal', ctx.nzDirection === 'horizontal')(
              'ant-space-vertical',
              ctx.nzDirection === 'vertical',
            )('ant-space-align-start', ctx.mergedAlign === 'start')(
              'ant-space-align-end',
              ctx.mergedAlign === 'end',
            )('ant-space-align-center', ctx.mergedAlign === 'center')(
              'ant-space-align-baseline',
              ctx.mergedAlign === 'baseline',
            );
          }
        },
        inputs: {
        ...
        consts: [
          ...
          [3, 'ngTemplateOutlet'],
          [1, 'ant-space-split'],
          [3, 'nzStringTemplateOutlet', 'nzStringTemplateOutletContext'],
        ],
        template: function NzSpaceComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            ɵɵrepeaterCreate(
              1,
              NzSpaceComponent_For_2_Template,
              3,
              2,
              null,
              null,
...
function normalizeSpaceSize(size) {
  const [horizontalSize, verticalSize] = (Array.isArray(size) ? size : [size, size]).map((s) =>
...
export { NZ_SPACE_COMPACT_SIZE, NZ_SPACE_COMPACT_ITEM_TYPE, NzSpaceCompactItemDirective };
